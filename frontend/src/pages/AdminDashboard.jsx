...
const Admin = () => {
  ...
  const [adminDepartment, setAdminDepartment] = useState(null); // To store the admin's department
  ...
  //   console.log(`Update status for complaint with ID ${complaintId}`);
  // };
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="d-flex align-items-center" style={{ listStyle: 'none' }}>
              {/* <li style={{ marginRight: '10px' }}>
                <Button variant="danger" onClick={handleShowStatusDialog} style={{ padding: '10px 20px', fontSize: '1.2rem' }}>
                  Status
                </Button>
              </li> */}
              <li>
